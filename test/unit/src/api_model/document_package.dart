...
const documentPackageJson =
    '{"Document": $documentJson,"DocumentSubscription": $documentSubscriptionJson,"Approval": $approvalJson,"ProjectMember":$documentPackageProjectMemberJson,"ProjectAccessType":"A","Fields": [$documentPackageFieldJson]}';
