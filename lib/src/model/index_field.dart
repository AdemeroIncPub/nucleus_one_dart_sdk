...
import '../api_model/index_field.dart' as api_mod;
import '../nucleus_one.dart';

class IndexField with NucleusOneAppDependent {
  IndexField._(
  ...
  factory IndexField.fromApiModel(api_mod.IndexField apiModel) {
    return IndexField._(
  ...
  api_mod.IndexField toApiModel() {
    return api_mod.IndexField()
