...
SignatureFormTemplate _$SignatureFormTemplateFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$SignatureFormTemplateToJson(SignatureFormTemplate instance) {
