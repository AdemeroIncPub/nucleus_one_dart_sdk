...
part of 'support_organization_tenant.dart';
...
SupportOrganizationTenantCollection
    _$SupportOrganizationTenantCollectionFromJson(Map<String, dynamic> json) {
  return SupportOrganizationTenantCollection()
    ..supportOrganizationTenants = (json['Tenants'] as List<dynamic>?)
        ?.map((e) =>
            SupportOrganizationTenant.fromJson(e as Map<String, dynamic>))
        .toList();
}

Map<String, dynamic> _$SupportOrganizationTenantCollectionToJson(
    SupportOrganizationTenantCollection instance) {
  ...
  writeNotNull('Tenants', instance.supportOrganizationTenants);
  return val;
}

SupportOrganizationTenant _$SupportOrganizationTenantFromJson(
    Map<String, dynamic> json) {
  return SupportOrganizationTenant()
...
Map<String, dynamic> _$SupportOrganizationTenantToJson(
    SupportOrganizationTenant instance) {
  final val = <String, dynamic>{};
