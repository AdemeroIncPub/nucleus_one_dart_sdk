...
class DocumentSignatureSession {
  ...
  factory DocumentSignatureSession.fromJson(Map<String, dynamic> json) => _$DocumentSignatureSessionFromJson(json);
...
// Serializable members must be explicitly marked with [JsonKey].
@JsonSerializable(ignoreUnannotated: true, includeIfNull: false)
class DocumentSignatureSessionRecipient {
  ...
  factory DocumentSignatureSessionRecipient.fromJson(Map<String, dynamic> json) => _$DocumentSignatureSessionRecipientFromJson(json);
...
class DocumentSignatureSessionPackageCollection {
  DocumentSignatureSessionPackageCollection() : items = [];
  ...
  factory DocumentSignatureSessionPackageCollection.fromJson(List<dynamic> json) {
    return DocumentSignatureSessionPackageCollection()
      ..items = json.map((m) => DocumentSignatureSessionPackage.fromJson(m)).toList();
  }
...
// Serializable members must be explicitly marked with [JsonKey].
@JsonSerializable(ignoreUnannotated: true, includeIfNull: false)
class DocumentSignatureSessionPackage {
