...
UserPreferences _$UserPreferencesFromJson(Map<String, dynamic> json) => UserPreferences()
  ...
  ..selectedTwainDevice = json['SelectedTwainDevice'] == null
      ? null
      : SelectedTwainDevice.fromJson(json['SelectedTwainDevice'] as Map<String, dynamic>)
  ..disableTwainDeviceSoftware = json['DisableTwainDeviceSoftware'] as bool?;
...
Map<String, dynamic> _$UserPreferencesToJson(UserPreferences instance) {
  ...
  writeNotNull('DisableTwainDeviceSoftware', instance.disableTwainDeviceSoftware);
  return val;
}
